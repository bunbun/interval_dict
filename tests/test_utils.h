...
interval_dict::IntervalDictExp<Key, Value, Interval, Impl>
copy (interval_dict::IntervalDictExp<Key, Value, Interval, Impl> data)
{
  return data;
}
...
interval_dict::BiIntervalDictExp<Key, Value, Interval, Impl, InverseImpl> copy (
  interval_dict::BiIntervalDictExp<Key, Value, Interval, Impl, InverseImpl> data)
{
  return data;
}
...
template<typename Key, typename Value, typename Interval, typename Impl>
std::vector<std::tuple<Key, Value, Interval>> intervals_as_vec (
  interval_dict::IntervalDictExp<Key, Value, Interval, Impl> idict,
...
// values
template<typename Key, typename Value, typename Interval, typename Impl>
std::set<std::tuple<Key, Value>> intervals_as_key_values (
  interval_dict::IntervalDictExp<Key, Value, Interval, Impl> idict,
  Interval interval = interval_dict::interval_extent<Interval>)
{
  std::set<std::tuple<Key, Value>> results;
  for (const auto &[key, value, _] : interval_dict::intervals (idict, interval))
  {
...
template<typename Key,
         ...
         typename InverseImpl>
std::vector<std::tuple<Key, Value, Interval>> intervals_as_vec (
  interval_dict::BiIntervalDictExp<Key, Value, Interval, Impl, InverseImpl> idict,
  Interval interval = interval_dict::interval_extent<Interval>)
{
  std::vector<std::tuple<Key, Value, Interval>> results;
  for (const auto &[key, value, interval] :
