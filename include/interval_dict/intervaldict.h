...
public:
    ...
    IntervalDictExp&
    operator=(const IntervalDictExp& other) = default;
    IntervalDictExp&
    operator=(IntervalDictExp&& other) noexcept = default;

    /// Construct from key-value-intervals
    IntervalDictExp(const std::vector<std::tuple<Key, Val, Interval>>& key_value_intervals);
...
IntervalDictExp<Key, Val, Interval, Impl>::IntervalDictExp(const std::vector<std::tuple<Key, Val, Interval>>&key_value_intervals)
{
...
template <typename Key, typename Val, typename IntervalType, typename Impl>
bool IntervalDictExp<Key, Val, IntervalType, Impl>::operator==(const IntervalDictExp& rhs) const
{
