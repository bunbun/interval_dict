...
/// \brief Definitions of free standing functions operating on
/// IntervalDictICLExp \author Leo Goodstadt Contact intervaldict@llew.org.uk

#ifndef INCLUDE_INTERVAL_DICT__INTERVALDICTICL_FUNC_H
#define INCLUDE_INTERVAL_DICT__INTERVALDICTICL_FUNC_H
 ...
 */
template <typename Stream, typename Key, typename Val, typename Interval>
Stream& operator<<(Stream& ostream,
                   const IntervalDictICLExp<Key, Val, Interval>& interval_dict)
{
        ...
        FlattenPolicy<Key, Val, Interval> keep_one_value)
{
    ...
    interval_dict.insert(erasures);
    return interval_dict;
}

} // namespace interval_dict
#endif // INCLUDE_INTERVAL_DICT__INTERVALDICTICL_FUNC_H
